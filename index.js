const e = new Error('Попал в несуществующую ячейку')
...
const A = '1*+=_'
// Лента
const L = '_________1111+111*111=_________________________________________________'.split('')
...
while (f) {
    ...
    switch (c[1]) {
      ...
      case '!':
        ...
        break
      default:
        console.error(new Error(`Не существующая команда перехода ${c}, ожидалось [>, <, !]`))
    }
...
console.log('Ответ: '+ L.filter(l => l !== '_').length)